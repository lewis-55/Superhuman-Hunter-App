...
//---------------------------------------------------
 ...
 //----------------------------------------------
 //Function : Displays the 'Find Your Superhero' from//
 const helpMe = ()=> {
...
// Appends the cloned Template to the Display
 ...
 const handleClick = (event) => {
    ...
    if (target.classList.contains("btn")) {
        ...
        if (target.previousElementSibiling.children[1].value === "") {
            return;
        }

        // Removr the Form from the Display
        display.querySelector(".card-body").remove();
        // Append the cloned Templates (Animation) to the Display
